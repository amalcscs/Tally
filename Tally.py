...
global Canvas2
Canvas2 = tk.Canvas(Canvas1, background="#ffffff",borderwidth="1", insertbackground="black", relief="ridge",selectbackground="blue", selectforeground="white")
Canvas2.place(relx=0.200, rely=0.131, relheight=0.900, relwidth=0.600)
Label6 = Label(Canvas2,text='List of Companies',borderwidth="0", width=8, background="blue",
                                     foreground="#00254a",
                                     font="-family {Segoe UI} -size 12 -weight bold ")
