...
def Gatewayoftally():
        ...
        Canvas1.place(relx=0, rely=0.07, relheight=0.960, relwidth=.850)
        ...
        Canvas3.place(relx=0.850, rely=0.07, relheight=0.95, relwidth=0.150)
        # Create a Button
        btn = Button(Canvas3, text = 'F2:Date', bd = '0',background="white",
                        font="-family {Segoe UI} -size 12  ",foreground="black")
        btn.place(x=5, y=5, height=30, width=163)
        ...
        btn = Button(Canvas3, text = 'F2:Company', bd = '0',background="white",
                        font="-family {Segoe UI} -size 12  ",foreground="black",command=ChangeCompany)
        btn.place(x=5, y=40, height=30, width=163)
        Label14 = Label(Canvas3,text='<',borderwidth="0", width=8, background="white",
                                            foreground="black",
                                            font="-family {Segoe UI} -size 12  ")
...
def ChangeCompany():
        ...
        Label5 = Label(Canvas1,text='Change Company',borderwidth="0", width=5, background="#3385ff",
                                            foreground="#00254a",
                                            font="-family {Segoe UI} -size 10 -weight bold ")
        Label5.place(relx=0, rely=0, relheight=0.03, relwidth=0.100)
        Label5 = Label(Canvas1,text='Abc',borderwidth="0", width=5, background="#3385ff",
                                            foreground="#00254a",
                                            font="-family {Segoe UI} -size 10 -weight bold ")
        Label5.place(relx=0.10, rely=0, relheight=0.03, relwidth=0.880)
        # Create a Button
        btn = Button(Canvas1, text = 'X', bd = '2',background="#3385ff",borderwidth="0",
                       font="-family {Segoe UI} -size 12  ",foreground="#00254a",command=call)
        btn.place(x=1265, rely=0, relheight=0.03, relwidth=0.03)
